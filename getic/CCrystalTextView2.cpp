...
//--| CCrystalTextView::MoveWordRight|----------------------------------------------------
...
//--| CCrystalTextView::SelectLine|-------------------------------------------------------
void CCrystalTextView::SelectLine(int line)
{
    CPoint ptEnd;
    CPoint ptStart;
    ...
    */
    ...
    InvalidateLines(max(ptStart.y-1,0), min(ptStart.y+1,lc));
    EnsureVisible(ptStart);
    
}

//--| CCrystalTextView::OnEditCopy|-------------------------------------------------------
void CCrystalTextView::OnEditCopy()
{
    Copy();
}

//--| CCrystalTextView::OnUpdateEditCopy|-------------------------------------------------
void CCrystalTextView::OnUpdateEditCopy(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_ptSelStart != m_ptSelEnd);
}

//--| CCrystalTextView::OnEditSelectAll|--------------------------------------------------
void CCrystalTextView::OnEditSelectAll()
{
    SelectAll();
}

//--| CCrystalTextView::OnUpdateEditSelectAll|--------------------------------------------
...
//--| CCrystalTextView::GetFromClipboard|-------------------------------------------------
